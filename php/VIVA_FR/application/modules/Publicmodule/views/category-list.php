				   ...
				   <div class="breatcome2_content">
				     <ul>
                         <li>
                             ...
                             <?php if($module and $series!=""){ ?>
                             <em class="fa fa-angle-right"></em>
                             <a href="<?=base_url()?>theme-subjects/<?php echo $module->slug; ?>/<?php  echo $this->uri->segment('3');?>">   
                             <?php echo $module->m_name; ?>
                             </a>     
							 <?php } else if($series==""){ ?>
                             <em class="fa fa-angle-right"></em>
                             <a href="<?=base_url()?>theme-category/<?php echo base64_encode('segment34544!!'.$module->m_id); ?>/<?php  echo $this->uri->segment('3');?>">   
                             <?php echo $module->m_name; ?>
                             </a>     
                             <?php } ?>
                             <?php if($series){ ?>
