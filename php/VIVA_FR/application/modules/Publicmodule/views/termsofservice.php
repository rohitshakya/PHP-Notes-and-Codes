            ...
            <div class="col-md-12">
                <!--
					<div class="section_title_style2" style="text-align: left;">
						<h2 style="padding-bottom:10px;"><//?=explode('-',$this->uri->segment(3))[0]?> - <//?=date("F", mktime(0, 0, 0, $this->uri->segment(4), 10))?></h2>
						<br>
					</div>
					-->
                <div class="section_title_style2" style="text-align: left;">
                    <div class="breatcome2_content">
                        <ul>
                            <li><a href="<?=base_url()?>">home</a> <em class="fa fa-angle-right"></em> <a
                                    href="<?=base_url('months/' . $this->uri->segment(2) . '/' . $this->uri->segment(3))?>"><?=explode('-', $this->uri->segment(3))[0]?></a>
                                <em class="fa fa-angle-right"></em> <a
                                    href="<?=base_url('subjects/' . $this->uri->segment(2))?>"><?=$this->uri->segment(2)?></a>
                                <em class="fa fa-angle-right"></em>
                                <?=date("F", mktime(0, 0, 0, $this->uri->segment(4), 10))?>
                            </li>
                        </ul>
                    </div>
                </div>
