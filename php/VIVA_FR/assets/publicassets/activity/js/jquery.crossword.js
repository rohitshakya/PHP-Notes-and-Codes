...
(function($){
	$.fn.crossword = function(entryData) {
			...
			this.after('<div id="puzzle-clues"><ol id="across"></ol><ol id="down"></ol></div>');
			...
			var puzInit = {
				...
				init: function() {
					...
					$('#' + currOri + ' li' ).eq(0).attr('style','display: block !important');
				...
				calcCoords: function() {
					...
					*/
					for (var i = 0, p = entryCount; i < p; ++i) {		
						...
						$('#' + puzz.data[i].orientation).append('<li tabindex="1" style="display: none" data-position="' + i + '">' + puzz.data[i].clue + '</li>'); 
					}				
						...
						for (var i=0; i < entries[x-1].length; ++i) {
							...
							if($(light).empty()){
								$(light)
									...
									.append('<input class="fieldChange" maxlength="1" val="" type="text" tabindex="-1" />');
							}
						};
			...
			var nav = {
				...
				updateByNav: function(e) {
					...
					$('.clues-active').attr('style','display: none !important;');;
			...
			var util = {
				...
				highlightClue: function() {
					...
					$(clueLiEls + '[data-position=' + activePosition + ']').attr('style','display: block !important;');
